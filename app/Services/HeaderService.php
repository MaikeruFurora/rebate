    ...
    public function headerListData($request){
        ...
        if ($request->ajax()) {
            ...
            if ($request->input('start_date') && $request->input('end_date')) {
                ...
                if (auth()->user()->RebateRole!='U' || in_array(auth()->user()->Position_id,$userPosition)) {

                    $headerList = Header::headerList()->whereDate('headers.created_at','>=',$start_date)->whereDate('headers.created_at','<=',$end_date);
                ...
                $res = $headerList->union($openHeaders)->get();
