                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal m-t-20" action="{{ route('auth.login.post') }}" method="POST">@csrf
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                <input class="form-control" name="Username" type="text" required placeholder="Username" autofocus maxlength="20" value="">
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-12">
                                <input class="form-control" name="Password" type="password" required placeholder="Password" maxlength="20" value="">
                            </div>
                        </div>
